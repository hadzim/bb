...
cnmspc.push_back("Sensor");
::TBS::Services::Introspection::Class c("TBS.BB.Services.Sensor.DataCollector", "DataCollector", cnmspc,"");
{
...
cnmspc.push_back("Services");
cnmspc.push_back("Sensor");
::TBS::Services::Introspection::Class c("TBS.BB.Services.Sensor.DataDistributor", "DataDistributor", cnmspc,"");
{
